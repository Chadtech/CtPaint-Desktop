...
privacyList =
    ...
    , "Chadtech will never look at your private user data without your permission. Private user data in this context, means data only the user could access through the normal operation of CtPaint. Private images would be an example."
